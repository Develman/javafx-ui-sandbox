...
public class DialogsTest extends Application
{
    ...
    private void showCustomDialog(Stage stage)
    {
        ...
        // You must check the resp, since input fields' texts are returned regardless of
        // what button was pressed. (ie. If user clicked 'Cancel' disregard the input)
